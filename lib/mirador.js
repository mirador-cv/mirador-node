...
// deprecation warning;
// in the early version of the api called it this
MiradorClient.prototype.classifyRaw = util.deprecate(
  MiradorClient.prototype.classifyBuffers,
  '`classifyRaw is deprecated. Use `classifyBuffers` instead.'
);
